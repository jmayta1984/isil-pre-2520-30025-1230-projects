...
let products = [
    ...
    Product(name: "Chicken & Green Pea Recipe", price: 28.99, image: "https://www.pedigree.com/sites/g/files/fnmzdf3076/files/migrate-product-files/images/vcwwacmkjnrwrgegjkly.png"),
